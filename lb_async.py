...
class BackendList:
	def __init__(self):
		self.servers=[]
		self.servers.append(('172.16.16.101',8000)) # IP eth1 dari mesin1
		self.servers.append(('172.16.16.102',8001)) # IP eth1 dari mesin2
		self.servers.append(('172.16.16.103',8002)) # IP eth1 dari mesin3
		self.current=0
	def getserver(self):
