...
class BackendList:
    def __init__(self):
        self.servers = []
        self.servers.append(('172.16.16.101', 8889)) # IP eth1 dari mesin1
        self.servers.append(('172.16.16.102', 8889)) # IP eth1 dari mesin2
        self.servers.append(('172.16.16.103', 8889)) # IP eth1 dari mesin3
        self.current = 0
...
def Server():
    ...
    with ThreadPoolExecutor(max_workers=20) as executor:
        while True:
            ...
            logging.warning(f"{client_address} diteruskan ke {backend_address}")
            try:
